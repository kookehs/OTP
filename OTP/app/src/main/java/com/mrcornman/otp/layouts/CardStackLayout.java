package com.mrcornman.otp.layouts;
...
import com.mrcornman.otp.animation.CardAnimator;
import com.mrcornman.otp.events.DefaultStackEventListener;
import com.mrcornman.otp.events.DragGestureDetector;
...
public class CardStackLayout extends RelativeLayout {
    ...
    private void setupAnimation(){
        ...
        final DragGestureDetector dd = new DragGestureDetector(CardStackLayout.this.getContext(),new DragGestureDetector.DragListener(){
            ...
            public boolean onDragContinue(MotionEvent e1, MotionEvent e2,
                ...
                final int direction = CardUtil.direction(x1, y1, x2, y2);
                mCardAnimator.drag(e1,e2,distanceX,distanceY);
            ...
            public  boolean onDragEnd(MotionEvent e1, MotionEvent e2) {
                ...
                float x2 = e2.getRawX();
                float y2 = e2.getRawY();
                float distance = CardUtil.distance(x1,y1,x2,y2);
                final int direction = CardUtil.direction(x1,y1,x2,y2);
